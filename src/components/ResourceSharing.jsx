  ...
  return (
    <div className="bg-[#0f172a] min-h-screen text-white px-4 md:px-16 py-16">
      ...
      <motion.h1
                   ...
                   viewport={{ once: true }}
                 >
                   Resource Sharing <span className="text-cyan-400">Platform</span>
      ...
      >
        <p>
          The Resource Sharing Platform is a full-stack web application built to
          enable students to share and access learning resources efficiently. It
          includes:
        </p>

        <ul className="list-disc list-inside mt-2 space-y-1 text-gray-200">
          <li>User registration and authentication with JWT.</li>
          <li>Upload and download resources securely using Cloudinary.</li>
          <li>Search and filter resources by categories and tags.</li>
          <li>Responsive UI built with React.</li>
          <li>Backend REST APIs using Node.js and Express.</li>
          <li>Real-time features using Socket.io basics.</li>
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-center items-center gap-10 flex-wrap">
            ...
            >
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Socket-io.svg"
                alt="Socket.io"
                className="w-20 h-20 mb-2"
              />
              <p>Socket.io</p>
        ...
        <div className="flex gap-4 mt-10 justify-center">
          <a
            href="https://github.com/Ayushkr3864/ResourceSharing-ShareNest-"
            target="_blank"
          ...
          <a
            href="https://resourcesharing-sharenest.onrender.com/"
            target="_blank"
            rel="noopener noreferrer"
