    ...
    <div className="bg-[#0f172a] min-h-screen text-white px-4 md:px-16 py-16">
      {/* Project Heading */}
       <motion.h1
              ...
              viewport={{ once: true }}
            >
              E-Library <span className="text-cyan-400">Management System</span>
      ...
      >
        <p>
          A modern web-based platform designed to simplify the management of
          digital books and user activity. The app enables users to browse,
          upload, and download e-books while providing administrators with tools
          to organize collections, monitor usage, and maintain records
          efficiently.
        </p>

        <ul className="list-disc list-inside mt-2 space-y-1 text-gray-200">
          <li>User registration and authentication with JWT.</li>
          <li>Password hash using Bcrypt.</li>
          <li>Download books securely.</li>
          <li>Role based login(Admin/User)</li>
          <li>Responsive UI built with React.</li>
          <li>Backend REST APIs using Node.js and Express.</li>
          <li>can read books from anywhere</li>
          <li>Database powered by MongoDB.</li>
        </ul>

        <p>
          This project helped me improve my understanding of full-stack
          development, REST API design, authentication and authorization,password hashing,database integration.
        </p>
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-center items-center gap-10 flex-wrap">
            ...
            <motion.div
              ...
              className="flex flex-col items-center"
            >
              <img src="/ejs.png" alt="React" className="w-20 h-20 mb-2" />
              <p>EJS</p>
            </motion.div>
        ...
        <div className="flex gap-4 mt-10 justify-center">
          <a
            href="https://github.com/Ayushkr3864/E-Library"
            target="_blank"
          ...
          <a
            href="https://personal-library-pa9j.onrender.com/"
            target="_blank"
            rel="noopener noreferrer"
